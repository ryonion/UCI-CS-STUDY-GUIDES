...
## ICS 32 - Python - programming with software libraries
- [HW4: Python Game: Othello](https://github.com/YifanTian/ICS_32_game_of_othello)

## ICS 33 - Python - understanding python and learning programming-related cs topics
